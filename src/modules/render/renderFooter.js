  ...
  footer.innerHTML = `
    <div class="container">
      <div class="footer__container">
        <div class="footer__item footer__item_category footer-category">
          ...
          <ul class="footer-category__list">
            <li class="footer-category__item">
              <h2 class="footer-category__subtitle">Женщины</h2>
            ...
            <li class="footer-category__item">
              <h2 class="footer-category__subtitle">Мужчины</h2>
              <ul class="footer-category__sublist">
                <li class="footer-category__subitem">
                  <a href="#" class="footer__link">Трусы</a>
                </li>
          ...
          <ul class="footer-social__list">
            <li class="footer-social__item">
              <a href="#" class="footer-social__link">
                <svg width="24" height="24" viewBox="0 0 24 24" aria-label="перейти во Вконтакте" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="footer-social__item">
              <a href="#" class="footer-social__link">
                <svg width="24" height="24" viewBox="0 0 24 24" aria-label="перейти в facebook"  fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="footer__item footer__item_copyright footer-copyrigth">
          <p>© INSPIRED, 2023</p>
        </div>
        <div class="footer__item footer__item_development footer-development">
          <ul class="footer-development__list">
            ...
            <li class="footer-development__item">
              Developer: <a href="#">Darya Anikeeva</a>
            </li>
          </ul>
        </div>
      </div>
